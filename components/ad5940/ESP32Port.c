...
#define GPIO_CS        4    // D10 in Arduino UNO terms, this is a dummy pin that will not be used (AD5940 library was programmed in such a way that chip selects are handled manually)
#define AD5940_CS_PIN  7    // this is the true CS pin, AD5940 will not work with the default CS pin.
