...
#define GPIO_SCLK      2   // D13 in Arduino UNO terms
#define GPIO_MISO      3   // D12 in Arduino UNO terms
#define GPIO_MOSI      4   // D11 in Arduino UNO terms
...
#define AD5940_CS_PIN  6    // this is the true CS pin, AD5940 will not work with the default CS pin.
#define AD5940_GP0INT_PIN 7 // D2 in Arduino UNO terms, this connects to GPIO0 of AF5940
#define AD5940_RST_PIN 8    // A3/D17 in Arduino UNO terms
